...
enum class SensorType(
    val length: Int = 1,
    val levels: List<Pair<Int, Int>> = emptyList(),
    val converter: SensorConverter<*> = DefaultConverter()
) {
    ...
    inline fun <reified T> consumeAndConvert(data: MutableList<Byte>): T =
        converter.convert(length, data) as T
}
