...
public class TextPainter<W extends Waypoint> extends AbstractPainter<JXMapViewer> {
    protected Type type;
    private Map<W, String> waypoints = new HashMap<>();

    public TextPainter(Type type) {
        this.type = type;
    }
     ...
     */
    public TextPainter<W> setWaypoints(Map<? extends W, String> waypoints) {
    ...
    private BufferedImage generateNumberGraphics(String numberString) {
        /*
