...
public class MoteFactory {
    ...
    public static Mote createMote(long devEUI, int xPos, int yPos, Environment environment, int transmissionPower,
                                  int spreadingFactor, LinkedList<MoteSensor> moteSensors, int energyLevel, LinkedList<GeoPosition> path, double movementSpeed){
    ...
    public static Mote createMote(long devEUI, int xPos, int yPos, Environment environment, int transmissionPower,
                                  int spreadingFactor, LinkedList<MoteSensor> moteSensors, int energyLevel, LinkedList<GeoPosition> path,
