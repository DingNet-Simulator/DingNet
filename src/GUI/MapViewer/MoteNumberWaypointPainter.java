 ...
 * @author rbair
 */
public class MoteNumberWaypointPainter<W extends Waypoint> extends AbstractPainter<JXMapViewer> {
     ...
     */
    public MoteNumberWaypointPainter() {
    ...
    protected void doPaint(Graphics2D g, JXMapViewer map, int width, int height) {
        ...
        for (W w : getWaypoints()) {
            renderer = new MoteNumberWaypointRenderer(waypoints.get(w));
