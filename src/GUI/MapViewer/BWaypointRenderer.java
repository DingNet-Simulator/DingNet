 ...
 * @author joshy
 */
public class BWaypointRenderer implements WaypointRenderer<Waypoint>
{
     ...
     */
    public BWaypointRenderer()
    {
        try
        {
            img = ImageIO.read(DefaultWaypointRenderer.class.getResource("/GUI/MapViewer/B.png"));
            int w = img.getWidth();
            int h = img.getHeight();
